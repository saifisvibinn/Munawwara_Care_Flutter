                      ...
                      child: Container(
                        ...
                        child: ExpansionTile(
                          ...
                          children: [
                            ...
                            _divider(dividerColor),
                            if (authState.insuranceCompany != null && authState.insuranceCompany!.hospitals.isNotEmpty) ...[
                              Padding(
                              ...
                              for (final hospital in authState.insuranceCompany!.hospitals) ...[
                                Padding(
                                ...
                                if (authState.insuranceCompany!.hospitals.last != hospital)
                                  _divider(dividerColor.withValues(alpha: 0.5)),
                              ],
                            ] else
                              _InfoTile(
                                icon: Icons.local_hospital_rounded,
                                label: 'Covered Hospitals',
                                value: 'No hospitals listed',
                                isDark: isDark,
                                textPrimary: textPrimary,
                                textMuted: textMuted,
                              ),
